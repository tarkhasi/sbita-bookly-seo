...
<div class="sbu-service-main <?php echo $attrs['item_class'] ?? $default_class ?>"
...
>
    ...
    <div class="sbu-service-detail-content">
        <div class="sbu-service-detail-info">
            <div class="sbu-service-detail-title" style="<?php echo $title_style ?>">
            ...
            <div class="sub-flex">
                <div class="sbu-service-detail-duration" title="<?php _e('Duration', 'sbita-bookly-ui'); ?>">
                    <?php echo sbs_duration($item['duration']); ?>
                </div>
                <div class="sbu-service-detail-price" title="<?php _e('Price', 'sbita-bookly-ui'); ?>">
                    <?php echo apply_filters('sbu_service_price', sbs_price($item['price']), $item); ?>
                </div>
            </div>
        </div>
